...
from Files.SQLAlchemyModels import Member, Employee, Approval
...
# def test_member_methods(session: Session):
#     """Simple test function using your actual data"""
#     # session = SessionLocal()
#     try:
#         print("Testing Member methods...")
        
#         # Test 1: Find Ahmad by phone
#         print("\n1. Testing get_member_by_phone:")
#         member_by_phone = LeadService.get_member_by_phone(session, "+971 509565289", "2")
#         if member_by_phone:
#             print(f"✅ Found: {member_by_phone.full_legal_name}")
#         else:
#             print("❌ Not found")
            
#         # Test 2: Find Ahmad by email  
#         print("\n2. Testing get_member_by_email:")
#         member_by_email = LeadService.get_member_by_email(session, "ahmad04.meda@gmail.com", "2")
#         if member_by_email:
#             print(f"✅ Found: {member_by_email.full_legal_name}")
#         else:
#             print("❌ Not found")
            
#         # Test 3: Find Ahmad by name
#         print("\n3. Testing get_members_by_name:")
#         members_by_name = LeadService.get_members_by_name(session, "Ahmad", "2")
#         if members_by_name:
#             print(f"✅ Found {len(members_by_name)} member(s):")
#             for member in members_by_name:
#                 print(f"   - {member.full_legal_name}")
#         else:
#             print("❌ Not found")
            
#         # Test 4: Test with wrong agent_id (should not find anything)
#         print("\n4. Testing with wrong agent_id:")
#         wrong_agent = LeadService.get_member_by_phone(session, "+971 509565289", "999")
#         if wrong_agent:
#             print("❌ Found member with wrong agent_id (this shouldn't happen)")
#         else:
#             print("✅ Correctly filtered by agent_id")
